...
export default function LogoSection() {
  return (
    <section className="w-full bg-gray-50">
      <div className="w-[1351px] h-32 relative bg-gray-50 mx-auto">
        <div className="w-[1146.12px] h-8 pr-9 left-[102.44px] top-[45.52px] absolute inline-flex justify-start items-start gap-8">
